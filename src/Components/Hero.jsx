...
import heroImage from '../img/blog.jpg'; // Import the image file correctly
function Hero() {
  return (
    <section className='flex w-[90%]  mx-auto mt-[12vh] h-[81vh]'>
        <div className='flex-1 flex flex-col gap-8'>
            ...
            <button class="button">Subscribe For more</button>
